...
7. **Capture, not prescription.** Action lines are point-in-time events — they record what was discovered, decided, or rejected during a specific session. They are not standing rules or directives for future commits. Deriving conventions, enforcing patterns, or synthesising guidance from the accumulated history is the responsibility of the consuming tool. The convention captures faithfully; interpretation and enforcement are downstream concerns.
